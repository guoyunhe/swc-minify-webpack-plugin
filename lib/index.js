...
var SwcMinifierWebpackPlugin = /** @class */ (function () {
    function SwcMinifierWebpackPlugin(options) {
    ...
    SwcMinifierWebpackPlugin.prototype.apply = function (compiler) {
        var _this = this;
    ...
    SwcMinifierWebpackPlugin.prototype.transformAssets = function (compilation) {
    ...
    SwcMinifierWebpackPlugin.prototype.processAssetsSync = function (assets, sourcemap, compilation) {
        var _this = this;
        assets.forEach(function (asset) {
            var _a = asset.source.sourceAndMap(), source = _a.source, map = _a.map;
            var sourceAsString = source.toString();
            var result = (0, core_1.minifySync)(sourceAsString, __assign(__assign({}, _this.options), { sourceMap: Boolean(sourcemap) }));
    ...
    SwcMinifierWebpackPlugin.prototype.processAssets = function (assets, sourcemap, compilation) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, (0, core_1.minify)(sourceAsString, __assign(__assign({}, this.options), { sourceMap: Boolean(sourcemap) }))];
                                    case 1:
                                        result = _b.sent();
                                        compilation.updateAsset(asset.name, sourcemap
                                            ? new webpack_sources_1.SourceMapSource(result.code, asset.name, result.map, sourceAsString, map, true)
    ...
    return SwcMinifierWebpackPlugin;
}());
exports.default = SwcMinifierWebpackPlugin;
